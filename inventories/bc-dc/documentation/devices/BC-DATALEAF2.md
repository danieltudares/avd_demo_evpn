...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | mgmt | 172.20.21.102/24 | 172.20.20.1 |
...
| --------- | --------------- | ------------ | --------- |
| BC_DATARACK1 | Vlan4094 | 10.255.252.0 | Port-Channel10 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | MLAG_PEER_BC-DATALEAF1_Ethernet10 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
| Ethernet11 | MLAG_PEER_BC-DATALEAF1_Ethernet11 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 10 |
...
interface Ethernet10
   description MLAG_PEER_BC-DATALEAF1_Ethernet10
   no shutdown
   channel-group 10 mode active
!
interface Ethernet11
   description MLAG_PEER_BC-DATALEAF1_Ethernet11
   no shutdown
   channel-group 10 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | MLAG_PEER_BC-DATALEAF1_Po10 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel10
   description MLAG_PEER_BC-DATALEAF1_Po10
   no shutdown
   switchport
...
router bgp 65101
   ...
   neighbor 10.255.251.0 description BC-DATALEAF1
