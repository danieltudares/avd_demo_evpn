...
Et1                            up             up                 P2P_LINK_TO_BC-SPINE1_Ethernet4
Et2                            up             up                 P2P_LINK_TO_BC-SPINE2_Ethernet4
...
Et10                           up             up                 
Et11                           up             up                 
Et12                           up             up                 MLAG_PEER_BC-DATALEAF3_Ethernet12
Et13                           up             up                 MLAG_PEER_BC-DATALEAF3_Ethernet13
...
Po12                           up             up                 MLAG_PEER_BC-DATALEAF3_Po12
...
Vlan3020        10.255.251.5/31      up         up              1500            
...
```
Last table change time   : 2:31:53 ago
...
---------- -------------------------------- ---------------------- --- 
Et1           BC-SPINE1.tudareslab.io          Ethernet4           120 
Et2           BC-SPINE2.tudareslab.io          Ethernet4           120 
Et12          BC-DATALEAF3.tudareslab.io       Ethernet12          120 
Et13          BC-DATALEAF3.tudareslab.io       Ethernet13          120
```
## show running-config

```
! Command: show running-config
! device: BC-DATALEAF4 (vEOS-lab, EOS-4.26.2F)
!
...
Arista vEOS-lab
Hardware version: 
Serial number: 64FA474BFBE3690E0FD4393D1942646B
Hardware MAC address: 5001.004c.4362
System MAC address: 5001.004c.4362
